...
SCHEMA = "breachscope.p2_35d_socbed_timeline_one_pass.v1"
ANALYSIS_ID = "p2-35d-socbed-acsac2021-timeline-one-pass-v1"
ATTACKS = [
    "misc_sqlmap",
    "infect_email_exe",
    "c2_take_screenshot",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run preregistered P2-35D SOCBED timeline alignment measurement."
    )
...
def main() -> int:
    ...
    if sys.version_info[:2] != (3, 11):
        raise SystemExit("P2-35D requires Python 3.11")
    if sys.platform != "win32":
        raise SystemExit("P2-35D requires Windows")
