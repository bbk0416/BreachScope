...
DETECTOR_COMMIT = "e2f78b3addb0a6f7549f8911537c9999b65e3609"
                ...
                json.dumps(
                    {
                        ...
                        "label": "ignore",
                        "expected_techniques": [],
                        "notes": "P2-11F external calibration; no independent event-level ground truth.",
                    },
                    ensure_ascii=False,
                )
                + "\n"
...
def main() -> int:
    ...
    aggregate = {
        "schema": "breachscope.p2_11f_external_calibration_result.v1",
        "evaluation_class": "external_calibration",
