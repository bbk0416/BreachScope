...
DETECTOR_COMMIT = "aa08c6beca2720a69165aed37562ba9730a8a62f"
EXPECTED_RULE_TREE = "9b5d45c4f0edc37c788cda17451de6cf6b9114b8b6353c4522d15c294add053c"
                ...
                json.dumps(
                    {
                        ...
                        "label": "ignore",
                        "expected_techniques": [],
                        "notes": "P2-11E external calibration; no independent event-level ground truth.",
                    },
                    ensure_ascii=False,
                )
                + "\n"
...
def main() -> int:
    ...
    aggregate = {
        "schema": "breachscope.p2_11e_external_calibration_result.v1",
        "evaluation_class": "external_calibration",
