...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the preregistered P2-30B EVTX stage/cache/parser benchmark."
    )
...
def main() -> int:
    ...
    if sys.version_info[:2] != (3, 11):
        raise SystemExit("P2-30B requires Python 3.11")
    if sys.platform != "win32":
        raise SystemExit("P2-30B requires Windows")
    ...
    lock_path = out_dir / "P2_30B_ONE_PASS.lock"
