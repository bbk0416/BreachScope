...
ANALYSIS_ID = "p2-35j-current-rulepack-postchange-replay-v1"
SCHEMA = "breachscope.p2_35j_current_rulepack_postchange_replay.v1"
...
def global_lock_path() -> Path:
    return Path.home() / ".breachscope" / "canonical_locks" / "P2_35J_CURRENT_RULEPACK_REPLAY.lock"
