#!/usr/bin/env python3
"""Run BreachScope pre-publication quality/security gate."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="BreachScope quality/security gate")
    ...
    result = run_quality_gate(args.root)
    if args.json:
        ...
        lines = [
            f"BreachScope quality gate: {result['status']} ({result['score']}/100)",
