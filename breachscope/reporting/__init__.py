...
if _reporting_py_path.exists():
    ...
    export_iocs_csv = _reporting_py_module.export_iocs_csv
    build_case_manifest = _reporting_py_module.build_case_manifest
    export_manifest = _reporting_py_module.export_manifest
    export_case_package = _reporting_py_module.export_case_package
else:
